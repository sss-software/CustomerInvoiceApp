...
public class CustomerInvoiceAppDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public CustomerInvoiceAppDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
