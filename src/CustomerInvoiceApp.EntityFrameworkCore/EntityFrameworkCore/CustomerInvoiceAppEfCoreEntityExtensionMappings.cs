...
public static class CustomerInvoiceAppEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE CustomerInvoiceAppModuleExtensionConfigurator CLASS (in the Domain.Shared project)
