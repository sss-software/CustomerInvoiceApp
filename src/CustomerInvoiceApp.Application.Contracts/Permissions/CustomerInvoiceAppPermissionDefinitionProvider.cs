...
public class CustomerInvoiceAppPermissionDefinitionProvider : PermissionDefinitionProvider
{
    ...
    {
        var myGroup = context.AddGroup(CustomerInvoiceAppPermissions.GroupName);

        //Define your own permissions here. Example:
        //myGroup.AddPermission(CustomerInvoiceAppPermissions.MyPermission1, L("Permission:MyPermission1"));
    }
